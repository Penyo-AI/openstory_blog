...
keywords: ["Director Studio", "AI video control", "AI filmmaking", "camera control AI video", "character pose control", "Plot Party Director Studio", "Seedance camera prompt", "AI video generation workflow"]
...
![Plot Party Director Studio generating character layout, scene, and props from an uploaded image](https://storage.googleapis.com/plotparty-storage-public/blogs/3d-director-sudio.png)
...
![Controlling a character's action and pose in Plot Party Director Studio](https://storage.googleapis.com/plotparty-storage-public/blogs/Controlling-character.png)
...
![Adjusting camera direction in Plot Party Director Studio before sending the shot to an AI video model](https://storage.googleapis.com/plotparty-storage-public/blogs/Adjust-camera.png)
