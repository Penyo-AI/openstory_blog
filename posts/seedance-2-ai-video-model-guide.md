...
Seedance 2.0 is available on [Plot Party](https://app.plotparty.ai/home) in Pro mode, alongside other top-tier models like Kling V3 and Veo 3.1.
...
Seedance 2.0 is available in **Pro mode** on [Plot Party](https://app.plotparty.ai/home). To use it:

1. [Create a new story](https://app.plotparty.ai/home) and select Pro mode
...
Want to compare Seedance 2.0 with other models? Check out our [AI video generation tools comparison](./ai-video-generation-tools-2026-comparison.md). Ready to start creating? [Jump into Plot Party →](https://app.plotparty.ai/home)
