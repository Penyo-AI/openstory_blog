...
Seedance 2.0 is available on [Plot Party](https://plotparty.ai/home?auth=register) in Pro mode, alongside other top-tier models like Kling V3 and Veo 3.1.
...
Seedance 2.0 is available in **Pro mode** on [Plot Party](https://plotparty.ai/home?auth=register). To use it:

1. [Create a new story](https://plotparty.ai/home?auth=register) and select Pro mode
